...
const adminService = {
  ...
  async updateUserStatus(userId, isActive) {
    try {
      ...
      logError(error, {
        context: "adminService.updateUserStatus",
        userId,
        isActive,
      });
      throw error;
  ...
  async bulkUpdateUsers(operations) {
    try {
      ...
      logError(error, {
        context: "adminService.bulkUpdateUsers",
  ...
  async getMedicalRecordsOverview(options = {}) {
    try {
      ...
      logError(error, {
        context: "adminService.getMedicalRecordsOverview",
        options,
      });
      throw error;
    }
  ...
  async getNotificationsManagement(options = {}) {
    try {
      ...
      logError(error, {
        context: "adminService.getNotificationsManagement",
        options,
      });
      throw error;
    }
  ...
  async createUser(userData) {
    try {
      ...
      logError(error, {
        context: "adminService.createUser",
        role: userData.role,
      });
      throw error;
    }
