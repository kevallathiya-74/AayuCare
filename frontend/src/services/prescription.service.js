...
class PrescriptionService {
  ...
  async getPatientPrescriptions(patientId, params = {}) {
    try {
      ...
      logError(error, {
        context: "PrescriptionService.getPatientPrescriptions",
      });
      throw error;
    }
  }
  ...
  async getDoctorPrescriptions(doctorId) {
    try {
      ...
      logError(error, {
        context: "PrescriptionService.getDoctorPrescriptions",
      });
      throw error;
    }
  }
  ...
  async updatePrescriptionStatus(prescriptionId, status) {
    try {
      ...
      logError(error, {
        context: "PrescriptionService.updatePrescriptionStatus",
      });
      throw error;
    }
  }
