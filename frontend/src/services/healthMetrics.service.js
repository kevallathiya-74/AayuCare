...
const healthMetricsService = {
  ...
  async getMetrics(patientId) {
    try {
      ...
      logError(error, {
        context: "healthMetricsService.getMetrics",
        patientId,
      });
      throw error;
    }
  ...
  async getMetricsByType(patientId, type, options = {}) {
    try {
      ...
      logError(error, {
        context: "healthMetricsService.getMetricsByType",
        patientId,
        type,
      });
      throw error;
  ...
  async getLatestMetric(patientId, type) {
    try {
      ...
      logError(error, {
        context: "healthMetricsService.getLatestMetric",
        patientId,
        type,
      });
      throw error;
  ...
  async updateMetric(patientId, metricId, metricData) {
    try {
      ...
      logError(error, {
        context: "healthMetricsService.updateMetric",
        patientId,
        metricId,
      });
      throw error;
  ...
  async deleteMetric(patientId, metricId) {
    try {
      ...
      logError(error, {
        context: "healthMetricsService.deleteMetric",
        patientId,
        metricId,
      });
      throw error;
