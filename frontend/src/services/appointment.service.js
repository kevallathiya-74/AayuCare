...
class AppointmentService {
  ...
  async getPatientAppointmentsCursor(patientId, filters = {}) {
    try {
      ...
      logError(error, {
        context: "AppointmentService.getPatientAppointmentsCursor",
        patientId,
      });
      throw error;
    }
  ...
  async getDoctorAppointmentsCursor(doctorId, filters = {}) {
    try {
      ...
      logError(error, {
        context: "AppointmentService.getDoctorAppointmentsCursor",
        doctorId,
      });
      throw error;
    }
  ...
  async getPatientAppointments(patientId) {
    try {
      ...
      logError(error, {
        context: "AppointmentService.getPatientAppointments",
        patientId,
      });
      throw error;
    }
  ...
  async getAppointment(appointmentId) {
    try {
      ...
      logError(error, {
        context: "AppointmentService.getAppointment",
        appointmentId,
      });
      throw error;
    }
  ...
  async updateAppointmentStatus(appointmentId, status) {
    try {
      ...
      logError(error, {
        context: "AppointmentService.updateAppointmentStatus",
        appointmentId,
      });
      throw error;
    }
  ...
  async cancelAppointment(appointmentId, cancelReason) {
    try {
      ...
      logError(error, {
        context: "AppointmentService.cancelAppointment",
        appointmentId,
      });
      throw error;
    }
  ...
  async getAvailableSlots(doctorId, date) {
    try {
      ...
      logError(error, {
        context: "AppointmentService.getAvailableSlots",
        doctorId,
      });
      throw error;
    }
