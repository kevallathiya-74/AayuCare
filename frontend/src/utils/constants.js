...
export const ONBOARDING_SLIDES = [
  ...
  },
  {
    ...
    description: 'Keep all your medical records safe and accessible in one place',
...
export const FAQ_DATA = [
  {
    ...
    answer: 'Go to the Appointments tab, select a doctor, choose a time slot, and confirm your booking.',
  },
  {
    id: 2,
    question: 'Can I cancel or reschedule an appointment?',
    answer: 'Yes, you can cancel or reschedule from the appointment details screen up to 2 hours before the scheduled time.',
  },
  {
    id: 3,
    question: 'How are my medical records stored?',
    answer: 'All your medical records are encrypted and stored securely in the cloud. Only you and your authorized doctors can access them.',
  },
  {
    id: 4,
    question: 'What payment methods are supported?',
    answer: 'We support UPI, credit/debit cards, net banking, and wallet payments.',
  },
  {
    id: 5,
