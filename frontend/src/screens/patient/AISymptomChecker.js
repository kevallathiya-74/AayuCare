...
const resolveDiseaseInfo = (conditionName) => {
  const fallback = {
    overview:
      "This condition summary is generated by AI. Please verify with a clinician for diagnosis and treatment.",
