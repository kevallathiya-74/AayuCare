...
const NotificationsScreen = ({ navigation }) => {
    ...
    const handleNotificationPress = useCallback(async (notification) => {
        try {
            ...
            logError(err, { context: 'NotificationsScreen.handleNotificationPress' });
        }
    }, [navigation]);
                ...
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            logError(err, { context: 'NotificationsScreen.handleDeleteNotification' });
    ...
    const getNotificationColor = (priority) => {
        switch (priority) {
            case 'urgent': return healthColors.error.main;
            case 'high': return healthColors.warning.main;
            case 'medium': return healthColors.info.main;
            case 'low': return healthColors.success.main;
            default: return healthColors.primary.main;
        }
    };
    ...
    const renderNotification = ({ item }) => (
        ...
        >
            <View style={styles.notificationContent}>
                ...
                >
                    <Ionicons name="trash-outline" size={20} color={healthColors.text.tertiary} />
                </TouchableOpacity>
            </View>
        </TouchableOpacity>
    );
        ...
        <SafeAreaView style={styles.container} edges={['top', 'left', 'right', 'bottom']}>
            ...
            {unreadCount > 0 && (
                <TouchableOpacity
                    ...
                    activeOpacity={0.7}
                >
                    <Ionicons name="checkmark-done" size={18} color={healthColors.primary.main} />
