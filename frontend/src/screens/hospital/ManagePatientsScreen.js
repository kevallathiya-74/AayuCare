 ...
 * Admin interface to manage patient accounts
 */
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.emptyState}>
                    <Ionicons name="person-add-outline" size={80} color={healthColors.text.tertiary} />
                    <Text style={styles.emptyTitle}>No Patients Yet</Text>
                    <Text style={styles.emptySubtitle}>Patient management will appear here</Text>
                </View>
            </ScrollView>
        </View>
    );
