...
const ManageDoctorsScreen = ({ navigation }) => {
                ...
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        ...
                        try {
                            ...
                            Alert.alert('Success', `Doctor ${newStatus ? 'activated' : 'deactivated'} successfully`);
                        } catch (err) {
                            logError(err, { context: 'ManageDoctorsScreen.handleToggleStatus' });
        ...
        >
            <View style={styles.doctorHeader}>
                <View style={[
                    ...
                    <Ionicons
                        name="person"
                        size={28}
                        color={item.isActive ? healthColors.primary.main : healthColors.text.disabled}
                    />
                </View>
                <View style={styles.doctorInfo}>
                    <Text style={styles.doctorName}>{item.name || 'Unknown'}</Text>
                    <Text style={styles.specialization}>{item.specialization || 'General'}</Text>
                    <View style={styles.statusRow}>
                        <View style={[
                            styles.statusDot,
                            { backgroundColor: item.isActive ? healthColors.success.main : healthColors.error.main }
                        ]} />
                ...
                <View style={styles.switchContainer}>
                    {updatingId === item._id ? (
                        ...
                        <Switch
                            ...
                            thumbColor={item.isActive ? healthColors.primary.main : healthColors.text.disabled}
            ...
            <View style={styles.doctorDetails}>
                <View style={styles.detailItem}>
                    <Ionicons name="mail" size={14} color={healthColors.text.tertiary} />
                    <Text style={styles.detailText}>{item.email || 'N/A'}</Text>
                </View>
                <View style={styles.detailItem}>
                    <Ionicons name="call" size={14} color={healthColors.text.tertiary} />
    ...
    const renderEmptyState = () => (
        <View style={styles.emptyState}>
            <Ionicons name="people-outline" size={80} color={healthColors.text.tertiary} />
        ...
        <SafeAreaView style={styles.container} edges={['top', 'left', 'right', 'bottom']}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => Alert.alert('Add Doctor', 'Add doctor feature coming soon')}
                    accessibilityRole="button"
