        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.emptyState}>
                    <Ionicons name="settings-outline" size={80} color={healthColors.text.tertiary} />
                    <Text style={styles.emptyTitle}>Settings</Text>
                    <Text style={styles.emptySubtitle}>Hospital settings will appear here</Text>
                </View>
            </ScrollView>
        </View>
    );
