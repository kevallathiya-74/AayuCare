...
const AdminSettingsScreen = ({ navigation }) => {
    ...
    const settingsSections = useMemo(() => [
        {
            ...
            items: [
                { icon: 'people', label: 'Manage Doctors', screen: 'ManageDoctors', color: healthColors.primary.main },
                { icon: 'person-add', label: 'Patient Management', screen: 'PatientManagement', color: healthColors.success.main },
                { icon: 'calendar', label: 'Appointments', screen: 'AdminAppointments', color: healthColors.info.main },
            ],
        },
        {
            title: 'Reports & Analytics',
            items: [
                { icon: 'document-text', label: 'Medical Reports', screen: 'AdminReports', color: healthColors.warning.main },
                { icon: 'analytics', label: 'Error Analytics', screen: 'ErrorAnalytics', color: healthColors.error.main },
            ],
        },
        {
            title: 'System',
            items: [
                { icon: 'notifications', label: 'Notifications', action: () => Alert.alert('Coming Soon', 'Notification settings coming soon'), color: healthColors.primary.main },
                { icon: 'shield-checkmark', label: 'Security', action: () => Alert.alert('Coming Soon', 'Security settings coming soon'), color: healthColors.success.main },
                { icon: 'information-circle', label: 'About', action: () => Alert.alert('AayuCare', 'Version 1.0.0\nHealthcare Management System'), color: healthColors.info.main },
            ],
        },
    ], []);
    ...
    const renderSettingItem = useCallback((item, index) => (
        <TouchableOpacity
            key={index}
