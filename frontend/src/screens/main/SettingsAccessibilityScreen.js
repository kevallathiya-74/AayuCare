...
const SettingsAccessibilityScreen = ({ navigation }) => {
    ...
    const SettingRow = ({ icon, label, value, onToggle, iconColor }) => (
        <View style={styles.settingRow}>
            <View style={styles.settingLeft}>
                <Ionicons name={icon} size={20} color={iconColor || healthColors.text.secondary} />
                <Text style={styles.settingLabel}>{label}</Text>
            </View>
            <Switch
                value={value}
                onValueChange={onToggle}
                trackColor={{ false: healthColors.border.light, true: healthColors.primary.main + '40' }}
                thumbColor={value ? healthColors.primary.main : healthColors.background.tertiary}
    ...
    const ActionRow = ({ icon, label, onPress, iconColor, showArrow = true }) => (
        <TouchableOpacity style={styles.actionRow} onPress={onPress} activeOpacity={0.7}>
            ...
            {showArrow && <Ionicons name="chevron-forward" size={20} color={healthColors.text.disabled} />}
        </TouchableOpacity>
    );
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        <Ionicons name="language" size={20} color={healthColors.primary.main} />
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        <Ionicons name="shield-checkmark" size={20} color={healthColors.primary.main} />
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        <Ionicons name="help-circle" size={20} color={healthColors.primary.main} />
                        <Text style={styles.sectionTitle}>HELP & SUPPORT:</Text>
                    </View>
                    <View style={styles.card}>
                        <TouchableOpacity style={styles.supportItem} activeOpacity={0.7}>
                            <Ionicons name="call" size={18} color={healthColors.primary.main} />
                            <Text style={styles.supportText}>• Call: 1800-XXX-XXXX</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.supportItem} activeOpacity={0.7}>
                            <Ionicons name="mail" size={18} color={healthColors.primary.main} />
                            <Text style={styles.supportText}>• Email: support@aayucare.com</Text>
                        </TouchableOpacity>
                    </View>
                </View>
