        ...
        <SafeAreaView style={styles.container} edges={['top', 'left', 'right', 'bottom']}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                    ...
                    >
                        ...
                        {selectedLanguage === language.code && (
                            <View style={styles.checkmark}>
                                <Ionicons name="checkmark-circle" size={28} color={healthColors.primary.main} />
                            </View>
                        )}
                    </TouchableOpacity>
                ))}
                ...
                <View style={styles.infoCard}>
                    <Ionicons name="information-circle" size={24} color={healthColors.primary.main} />
                    <View style={styles.infoText}>
                        <Text style={styles.infoTitle}>About Language Support</Text>
                        <Text style={styles.infoDescription}>
                            AayuCare supports multiple languages to make healthcare accessible to everyone.
                ...
                <View style={styles.featuresList}>
                    ...
                    <View style={styles.featureItem}>
                        ...
                        <Text style={styles.featureText}>All screen titles and buttons</Text>
                    </View>
                    <View style={styles.featureItem}>
                        <Ionicons name="checkmark-circle" size={20} color="#10B981" />
                    ...
                    <View style={styles.featureItem}>
                        <Ionicons name="checkmark-circle" size={20} color="#10B981" />
                        <Text style={styles.featureText}>Error messages and notifications</Text>
                    </View>
                    <View style={styles.featureItem}>
                        <Ionicons name="checkmark-circle" size={20} color="#10B981" />
                        <Text style={styles.featureText}>AI insights and recommendations</Text>
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView>
