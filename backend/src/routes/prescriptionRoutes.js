...
// @access  Private (Doctor/Admin only)
router.patch('/:prescriptionId/status', authorize('doctor', 'admin'), prescriptionController.updatePrescriptionStatus);

// @route   DELETE /api/prescriptions/:prescriptionId
// @desc    Delete a prescription
// @access  Private (Admin only)
router.delete('/:prescriptionId', authorize('admin'), prescriptionController.deletePrescription);
